  ...
  return (
    <section aria-labelledby="evolve-title" className="tournament">
      <header className="tournament__header">
        <p className="eyebrow">Evolve / Tournament</p>
        <h1 className="display" id="evolve-title">
          A finite tournament of repeatable strategies.
        </h1>
        <p className="lede">
          Eight specified Iterated Prisoner&apos;s Dilemma policies meet in a
          reproducible round-robin. The table rewards a strategy&apos;s average
          payoff per round, never the luck of a longer match.
        </p>
      </header>
      ...
      >
        <aside className="tournament__method">
          ...
          <p>
            ...
            (1984) used computer tournaments to compare Iterated Prisoner&apos;s
            Dilemma strategies. This is a deliberately smaller, reproducible
            model—not a reconstruction of those historical entrants or scoring
            rules.
          </p>
          <p>
        ...
        >
          <div className="tournament__section-heading">
            <div>
              ...
              <h2 id="ranking-title">Mean payoff across the selected field</h2>
            </div>
        ...
        <section aria-labelledby="heatmap-title" className="tournament__matrix">
          <div className="tournament__section-heading">
            <div>
          ...
          <div
            ...
            tabIndex={0}
          >
            <div className="tournament-heatmap" style={{ gridTemplateColumns }}>
          ...
          <details className="tournament-table">
            ...
            <div className="tournament-table__scroll" tabIndex={0}>
              <table>
                <caption>
                  Exact mean per-round payoff for each row strategy against each
                  column strategy.
                </caption>
                <thead>
                  <tr>
                ...
                <tbody>
                  {result.matrix.map((row) => (
                    <tr key={row.strategy}>
                      <th scope="row">{ipdStrategyById[row.strategy].name}</th>
                      {row.payoffs.map((entry) => (
