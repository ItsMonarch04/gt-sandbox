...
**Status: v0.14.11 — classroom experience + state tests (`/12-F5-O8`). App not yet deployed.** The complete engineering handoff lives in [CONTEXT.md](CONTEXT.md).
...
- **Portfolio Version:** v0.14.11_2026-08-05_00:45:00 (IST)
