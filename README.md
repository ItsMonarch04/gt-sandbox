...
**Status: v0.14.12 — classroom route + UI tests (`/13-F5-O8`). App not yet deployed.** The complete engineering handoff lives in [CONTEXT.md](CONTEXT.md).
...
- **Portfolio Version:** v0.14.12_2026-08-05_01:00:00 (IST)
