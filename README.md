...
**Status: v0.14.7 — common-value analysis + auction tests (`/8-F5-O8`). App not yet deployed.** The complete engineering handoff lives in [CONTEXT.md](CONTEXT.md).
...
- **Portfolio Version:** v0.14.7_2026-08-03_00:45:00 (IST)
