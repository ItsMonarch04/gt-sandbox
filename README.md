...
**Status: v0.14.10 — classroom aggregation + assignment links (`/11-F5-O8`). App not yet deployed.** The complete engineering handoff lives in [CONTEXT.md](CONTEXT.md).
...
- **Portfolio Version:** v0.14.10_2026-08-05_00:30:00 (IST)
